...
int main (int argc, char *argv[]) {
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoDensity.avg.dat");
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoSigma1_00.avg.dat");
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoSigma1_11.avg.dat");
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoSigma1_22.avg.dat");
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoSigma_00.avg.dat");
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoSigma_11.avg.dat");
  ...
  strcpy (str, "./output/");
  strcat (str, filestr);
  strcat (str, ".MesoSigma_22.avg.dat");
